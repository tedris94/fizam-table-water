...
export function ProductCategoriesView({ role }: { role: string }) {
  return (
    <TaxonomyManagerView<Category>
      role={role}
      title="Product Categories"
      description="Manage product categories shown in the catalog and order page."
      apiBase="/api/admin/product-categories"
      emptyLabel="No categories yet. Add your first category."
      renderRow={(item) => (
        <div>
