...
export function Navbar() {
  ...
  const smoothScroll = (e: React.MouseEvent<HTMLAnchorElement>, targetId: string) => {
    if (targetId.startsWith('#') && typeof window !== 'undefined' && window.location.pathname === '/') {
      e.preventDefault()
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/order" className="hover:text-blue-200 transition-colors">
              Order
            </a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4">
            <a href="/" className="block hover:text-blue-200 transition-colors" onClick={() => setMobileMenuOpen(false)}>
              Home
            </a>
            <a
              href="/about"
            ...
            <a href="/order" className="block hover:text-blue-200 transition-colors" onClick={() => setMobileMenuOpen(false)}>
              Order
            </a>
